package cn.oneweone.video.base;
...
import cn.oneweone.video.net.AsyncHttpGet;
import cn.oneweone.video.net.AsyncHttpPost;
import cn.oneweone.video.net.BaseRequest;
import cn.oneweone.video.net.DefaultThreadPool;
import cn.oneweone.video.net.ThreadCallBack;
import cn.oneweone.video.net.utils.CheckNetWorkUtil;
...
import cn.oneweone.video.vo.OrderVO;
...
//					}else{
						PayUtils.pay((BaseActivity)context, vo.getOrder_no(), String.valueOf(mStrPayMode), String.valueOf(Constants.VIP_TENURE), feeDesp, mHandler);
//					}
				}
				break;
			}
