		            ...
		            contDownTimer = new CountDownTimer((second-1) * 1000, 1000) {  
		                ...
		                public void onFinish() {  
		                    if(!isFinishing() && contDownTimer != null){
		                    	...
		                    	mVideoView.pause();
		                    	isPlayer = false;
		                    	final int userType = MyApp.preferencesUtils.getInt(Preferences.USER_STATUS, Constants.MEMBER_TYPE_IS_NOT);
		                    	if(userType == 0){
		                    		PayUtils.isPay(context, vo.getAuthority(), new OnAlertSelectId() {
