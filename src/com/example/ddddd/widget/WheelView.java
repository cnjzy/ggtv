 ...
 */
package com.example.ddddd.widget;
...
public class WheelView extends View {
    ...
    private static final int VALUE_TEXT_COLOR = 0xFF2CADFF;
    ...
    private Drawable centerBottomDrawable;
    ...
    private void initResourcesIfNecessary() {
        if (itemsPaint == null) {
            ...
            itemsPaint.setTextSize(getResources().getDimension(R.dimen.sp_15));
        }

        if (valuePaint == null) {
            // valuePaint = new TextPaint(Paint.ANTI_ALIAS_FLAG | Paint.FAKE_BOLD_TEXT_FLAG | Paint.DITHER_FLAG);
            valuePaint = new TextPaint(Paint.ANTI_ALIAS_FLAG);
            valuePaint.setTextSize(getResources().getDimension(R.dimen.sp_15));
        }

        if (centerBottomDrawable == null) {
            centerBottomDrawable = getContext().getResources().getDrawable(R.drawable.line_bg);
        }
        if (centerTopDrawable == null) {
            centerTopDrawable = getContext().getResources().getDrawable(R.drawable.line_bg);
        }
    ...
    private void drawValue(Canvas canvas) {
        int color = getContext().getResources().getColor(R.color.order_textview_color_select);
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        int width = getWidth();
        centerBottomDrawable.setBounds(0, center, width, center + offset * 2);
        centerBottomDrawable.draw(canvas);

        centerTopDrawable.setBounds(0, center - 2 * offset, width, center);
        centerTopDrawable.draw(canvas);
    }
