...
public class MultiDirectionSlidingDrawer extends ViewGroup {
    ...
    /**
     * Sets the listener that receives a notification when the drawer starts or ends a scroll. A fling is considered as
     * a scroll. A fling will also trigger a drawer opened or drawer closed event.
     * 
